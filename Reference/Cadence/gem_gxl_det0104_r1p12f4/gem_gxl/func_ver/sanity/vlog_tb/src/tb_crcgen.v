...
//------------------------------------------------------------------------------
//
//   Filename:           tb_crcgen.v
//   Module Name:        tb_crcgen
//
...
// this is used for generating CRC in from parallel data
// this is reversed bit order
module tb_crcgen (
   din,
   stripe_in,
   stripe_out);
...
// -----------------------------------------------------------------------------
   ...
   input          din;                 // data into CRC checker
   input   [31:0] stripe_in;           // stripe input
   output  [31:0] stripe_out;          // stripe output
