//------------------------------------------------------------------------------
// File      : cdn_gem_demo_c_uc_enet_txrx_1pkt_test.c
...
//------------------------------------------------------------------------------
/*!
// @page cdn_gem_demo_c_uc_enet_txrx_1pkt_test
// 
// Description
// ===========
// 
// A single packet is transmitted and received using an external loopback
...
//      - One IPoE IPv6/UDP databuffer is written.
...
//    * Wait until the packet has been transmitted and received.
 ...
 *         A single packet is transmitted and received using an external
 *         loopback connection in the testbench.
 */
...
int main(int argc, char ** _argv) {
  ...
  // 2nd descriptor (last)
  word0 = byte2word((uintptr_t)mem_descr_tx[0x0b],
                    (uintptr_t)mem_descr_tx[0x0a],
                    (uintptr_t)mem_descr_tx[0x09],
                    (uintptr_t)mem_descr_tx[0x08]);
  word1 = byte2word(0xc0                         ,
                    (uintptr_t)mem_descr_tx[0x0e],
                    (uintptr_t)mem_descr_tx[0x0d],
                    (uintptr_t)mem_descr_tx[0x0c]);
  ...
  // 2nd descriptor
  word0 = byte2word((uintptr_t)mem_descr_rx[0x0b],
                    (uintptr_t)mem_descr_rx[0x0a],
                    (uintptr_t)mem_descr_rx[0x09],
                    0x02                         );
