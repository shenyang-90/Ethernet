//----------------------------------------------------------------------------
// Project    : cdn_demo_sys_bus_reg_adapter UVC
...
//----------------------------------------------------------------------------
// Class: cdn_demo_sys_bus_reg_adapter
...
`ifndef CDN_DEMO_SYS_BUS_REG_ADAPTER
`define CDN_DEMO_SYS_BUS_REG_ADAPTER

class cdn_demo_sys_bus_reg_adapter extends uvm_reg_adapter;

  //------------------------------------------------------------------------
  // UVM AUTOMATION MACROS.
  //------------------------------------------------------------------------

  `uvm_object_utils(cdn_demo_sys_bus_reg_adapter)
  ...
  //------------------------------------------------------------------------
  function new(string name="cdn_demo_sys_bus_reg_adapter");
    super.new(name);
  ...
  //------------------------------------------------------------------------
  virtual task write(input int addr, input int data);
  ...
  //------------------------------------------------------------------------
  virtual task read(input int addr, output int data);
    cdn_apb_vip_driver _driver;
    $cast(_driver, driver);
    _driver.read(addr,data);
  endtask : read

endclass // cdn_demo_sys_bus_reg_adapter
