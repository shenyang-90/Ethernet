...
struct emac_regs {
  ...
  volatile uint32_t fatal_or_non_fatal_int_sel;   /*       0x64 - 0x68       */
  volatile uint32_t lockup_config;                /*       0x68 - 0x6c       */
  volatile uint32_t rx_mac_lockup_time;           /*       0x6c - 0x70       */
  ...
  volatile char pad__7[0x50];                     /*      0x2b0 - 0x300      */
  ...
  volatile char pad__21[0x40];                    /*      0x9c0 - 0xa00      */
  volatile uint32_t ras_status;                   /*      0xa00 - 0xa04      */
  volatile uint32_t ras_int_status;               /*      0xa04 - 0xa08      */
  volatile uint32_t ras_int_enable;               /*      0xa08 - 0xa0c      */
  volatile uint32_t ras_int_disable;              /*      0xa0c - 0xa10      */
  volatile uint32_t ras_int_mask;                 /*      0xa10 - 0xa14      */
  volatile uint32_t ras_csr_err_count;            /*      0xa14 - 0xa18      */
  volatile uint32_t ras_dp_err_count;             /*      0xa18 - 0xa1c      */
  volatile uint32_t ras_ecc_err_count;            /*      0xa1c - 0xa20      */
  volatile uint32_t txdpram_non_crr_err_addr;     /*      0xa20 - 0xa24      */
  volatile uint32_t rxdpram_non_crr_err_addr;     /*      0xa24 - 0xa28      */
  volatile char pad__22[0x4d8];                   /*      0xa28 - 0xf00      */
