...
cp $IPF_DESIGN_FLOW_SCRIPTS/nc/run_FULLDYNAMIC_sdf_sim.tcl $IPF_DESIGN_FLOW_SCRIPTS/nc/local_SDF.tcl
cp $IPF_DESIGN_FLOW_SCRIPTS/nc/run_FULLDYNAMIC_sim.tcl $IPF_DESIGN_FLOW_SCRIPTS/nc/local.tcl
set RUNSIM_SDF = $IPF_DESIGN_FLOW_SCRIPTS/nc/local_SDF.tcl
set RUNSIM = $IPF_DESIGN_FLOW_SCRIPTS/nc/local.tcl

set NCSIM_INPUT_PAR_SHIFT = $IPF_DESIGN_FLOW_SCRIPTS/nc/support_files/FULLDYNAMIC_data_scan_ex1_ts1_verilog_parallel.inp
set NCSIM_INPUT_SER_SHIFT = $IPF_DESIGN_FLOW_SCRIPTS/nc/support_files/FULLDYNAMIC_data_scan_ex1_ts1_verilog_serial.inp
set NCSIM_INPUT_PAR_SHIFT_SDF = $IPF_DESIGN_FLOW_SCRIPTS/nc/support_files/FULLDYNAMIC_data_scan_ex1_ts1_verilog_parallel_sdf.inp
set NCSIM_INPUT_SER_SHIFT_SDF = $IPF_DESIGN_FLOW_SCRIPTS/nc/support_files/FULLDYNAMIC_data_scan_ex1_ts1_verilog_serial_sdf.inp

set NCSIM_INPUT_PAR_STUCKAT = $IPF_DESIGN_FLOW_SCRIPTS/nc/support_files/FULLDYNAMIC_data_logic_ex2_ts1_verilog_parallel.inp
set NCSIM_INPUT_SER_STUCKAT = $IPF_DESIGN_FLOW_SCRIPTS/nc/support_files/FULLDYNAMIC_data_logic_ex2_ts1_verilog_serial.inp
set NCSIM_INPUT_PAR_STUCKAT_SDF = $IPF_DESIGN_FLOW_SCRIPTS/nc/support_files/FULLDYNAMIC_data_logic_ex2_ts1_verilog_parallel_sdf.inp
set NCSIM_INPUT_SER_STUCKAT_SDF = $IPF_DESIGN_FLOW_SCRIPTS/nc/support_files/FULLDYNAMIC_data_logic_ex2_ts1_verilog_serial_sdf.inp

set NCSIM_INPUT_PAR_ATSPEED = $IPF_DESIGN_FLOW_SCRIPTS/nc/support_files/FULLDYNAMIC_data_logic_ex3_ts1_verilog_parallel.inp
set NCSIM_INPUT_SER_ATSPEED = $IPF_DESIGN_FLOW_SCRIPTS/nc/support_files/FULLDYNAMIC_data_logic_ex3_ts1_verilog_serial.inp
set NCSIM_INPUT_PAR_ATSPEED_SDF = $IPF_DESIGN_FLOW_SCRIPTS/nc/support_files/FULLDYNAMIC_data_logic_ex3_ts1_verilog_parallel_sdf.inp
set NCSIM_INPUT_SER_ATSPEED_SDF = $IPF_DESIGN_FLOW_SCRIPTS/nc/support_files/FULLDYNAMIC_data_logic_ex3_ts1_verilog_serial_sdf.inp
...
if ($WAVES_P == 1) then 
 ...
 printf "#Specify here the database creation\n" >> ${IPF_DESIGN_FLOW_SCRIPTS}/nc/support_files/FULLDYNAMIC_data_scan_ex1_ts1_verilog_parallel_sdf.inp
 ...
 printf "#Specify here the database creation\n" >> ${IPF_DESIGN_FLOW_SCRIPTS}/nc/support_files/FULLDYNAMIC_data_logic_ex2_ts1_verilog_parallel_sdf.inp
 ...
 printf "#Specify here the database creation\n" >> ${IPF_DESIGN_FLOW_SCRIPTS}/nc/support_files/FULLDYNAMIC_data_logic_ex3_ts1_verilog_parallel_sdf.inp
...
if ($WAVES_S == 1) then  
 ...
 printf "#Specify here the database creation\n" >> ${IPF_DESIGN_FLOW_SCRIPTS}/nc/support_files/FULLDYNAMIC_data_scan_ex1_ts1_verilog_serial_sdf.inp
 ...
 printf "#Specify here the database creation\n" >> ${IPF_DESIGN_FLOW_SCRIPTS}/nc/support_files/FULLDYNAMIC_data_logic_ex2_ts1_verilog_serial_sdf.inp
 ...
 printf "#Specify here the database creation\n" >> ${IPF_DESIGN_FLOW_SCRIPTS}/nc/support_files/FULLDYNAMIC_data_logic_ex3_ts1_verilog_serial_sdf.inp
...
if ($WAVES_P0 == 1) then 
 ...
 printf "#Specify here the database creation\n" >> ${IPF_DESIGN_FLOW_SCRIPTS}/nc/support_files/FULLDYNAMIC_data_scan_ex1_ts1_verilog_parallel.inp
 ...
 printf "#Specify here the database creation\n" >> ${IPF_DESIGN_FLOW_SCRIPTS}/nc/support_files/FULLDYNAMIC_data_logic_ex2_ts1_verilog_parallel.inp
 ...
 printf "#Specify here the database creation\n" >> ${IPF_DESIGN_FLOW_SCRIPTS}/nc/support_files/FULLDYNAMIC_data_logic_ex3_ts1_verilog_parallel.inp
...
if ($WAVES_S0 == 1) then  
 ...
 printf "#Specify here the database creation\n" >> ${IPF_DESIGN_FLOW_SCRIPTS}/nc/support_files/FULLDYNAMIC_data_scan_ex1_ts1_verilog_serial.inp
 ...
 printf "#Specify here the database creation\n" >> ${IPF_DESIGN_FLOW_SCRIPTS}/nc/support_files/FULLDYNAMIC_data_logic_ex2_ts1_verilog_serial.inp
 ...
 printf "#Specify here the database creation\n" >> ${IPF_DESIGN_FLOW_SCRIPTS}/nc/support_files/FULLDYNAMIC_data_logic_ex3_ts1_verilog_serial.inp
...
if ( (($FORCES == 1) || ($WAVES_P0 == 1) || ($WAVES_S0 == 1) || ($GUI_S0 == 1) || ($GUI_P0 == 1)) && ($ZERO_SIM == 1) )then
  ...
  if ($ZERO_SIM == 1) then
    ...
    $LSF wish $IPF_DESIGN_FLOW_SCRIPTS/nc/run_FULLDYNAMIC_sim.tcl 
  endif   
endif
...
if ( (($FORCES == 1) || ($WAVES_P == 1) || ($WAVES_S == 1) || ($GUI_S == 1) || ($GUI_P == 1)) && ($SDF_SIM == 1) )then
  ...
  if ($SDF_SIM == 1) then
    ...
    $LSF wish $IPF_DESIGN_FLOW_SCRIPTS/nc/run_FULLDYNAMIC_sdf_sim.tcl 
  endif
endif
