...
## ET clock constraint file for at-speed ATPG (auto-generated by flow)

  set ATPG_CLOCK_CONSTRAINTS_FILE "$DUT_PATH/cfg/${CONFIG}/dft/constraints/clock_constraints_${CONFIG}.txt"
...
## ET uses the path exception information to create dynamic test patterns 
...
## List of any additional netlist files required for ATPG simulation 
## e.g hard macros, analog stub files etc, uncomment if required.
## This is a tcl list example format
  #    set SIM_OTHER_MODULES_NETLISTS {filename1.vg \
  #                                    filename2.vg }

## ALTERNATIVELY,you may specify a file which includes the list of files to be 
## used for ATPG simulation
  #    set SIM_OTHER_MODULES_NETLISTS filelist.f
  #    set SIM_OTHER_MODULES_NETLISTS
...
## Specify a list of all existing ports that are to be used as
## scan clock inputs
  set TEST_CLK_PORTS  { pclk tx_byte_clk pixel_clk_if0 pixel_clk_if1 esc_clk }
...
## active low test reset inputs
  set TEST_RSTN_PORTS { presetn pixel_reset_n_if0 pixel_reset_n_if1 esc_reset_n tx_byte_reset_n }
