...
set HELP15   = "\t-other_args <filename>  An option to give additional arguments to xrun (former irun), captured in <filename> file. \n"
set HELP15a  = "\t			The format must conform to xrun syntax. ONLY FOR ADVANCED USERS! \n\n"
...
set HELPEXT="$HELP2$HELP3$HELP4${HELP5}${HELP5a}${HELP6}${HELP7}${HELP7a}${HELP8}$HELP9${HELP9a}${HELP10}${HELP11}${HELP11a}${HELP12}${HELP12a}${HELP13}${HELP14}${HELP15}${HELP15a}${HELP16}\n"
...
cp $IPF_DESIGN_FLOW_SCRIPTS/nc/run_zero_sim.tcl $IPF_DESIGN_FLOW_SCRIPTS/nc/local_ZERO.tcl
set RUNSIM_SDF = $IPF_DESIGN_FLOW_SCRIPTS/nc/local_SDF.tcl
set RUNSIM_ZERO = $IPF_DESIGN_FLOW_SCRIPTS/nc/local_ZERO.tcl

set NCSIM_INPUT_PAR_SHIFT_ZERO = $IPF_DESIGN_FLOW_SCRIPTS/nc/support_files/FULLSCAN_data_scan_ex1_ts1_1_verilog_parallel.inp
set NCSIM_INPUT_SER_SHIFT_ZERO = $IPF_DESIGN_FLOW_SCRIPTS/nc/support_files/FULLSCAN_data_scan_ex1_ts1_verilog_serial.inp
set NCSIM_INPUT_PAR_SHIFT_SDF = $IPF_DESIGN_FLOW_SCRIPTS/nc/support_files/FULLSCAN_data_scan_ex1_ts1_1_verilog_parallel_sdf.inp
set NCSIM_INPUT_SER_SHIFT_SDF = $IPF_DESIGN_FLOW_SCRIPTS/nc/support_files/FULLSCAN_data_scan_ex1_ts1_verilog_serial_sdf.inp

set NCSIM_INPUT_PAR_STUCKAT_ZERO = $IPF_DESIGN_FLOW_SCRIPTS/nc/support_files/FULLSCAN_data_logic_ex2_ts1_2_verilog_parallel.inp
set NCSIM_INPUT_SER_STUCKAT_ZERO = $IPF_DESIGN_FLOW_SCRIPTS/nc/support_files/FULLSCAN_data_logic_ex2_ts1_verilog_serial.inp
set NCSIM_INPUT_PAR_STUCKAT_SDF = $IPF_DESIGN_FLOW_SCRIPTS/nc/support_files/FULLSCAN_data_logic_ex2_ts1_2_verilog_parallel_sdf.inp
...
set NCSIM_INPUT_PAR_ATSPEED_ZERO = $IPF_DESIGN_FLOW_SCRIPTS/nc/support_files/DELAY_data_logic_ex2_ts1_2_verilog_parallel.inp
set NCSIM_INPUT_SER_ATSPEED_ZERO = $IPF_DESIGN_FLOW_SCRIPTS/nc/support_files/DELAY_data_logic_ex2_ts1_verilog_serial.inp
set NCSIM_INPUT_PAR_ATSPEED_SDF = $IPF_DESIGN_FLOW_SCRIPTS/nc/support_files/DELAY_data_logic_ex2_ts1_2_verilog_parallel_sdf.inp
set NCSIM_INPUT_SER_ATSPEED_SDF = $IPF_DESIGN_FLOW_SCRIPTS/nc/support_files/DELAY_data_logic_ex2_ts1_verilog_serial_sdf.inp


printf "" >> $NCSIM_INPUT_PAR_SHIFT_ZERO
printf "" >> $NCSIM_INPUT_SER_SHIFT_ZERO
printf "" >> $NCSIM_INPUT_PAR_SHIFT_SDF
printf "" >> $NCSIM_INPUT_SER_SHIFT_SDF

printf "" >> $NCSIM_INPUT_PAR_STUCKAT_ZERO
printf "" >> $NCSIM_INPUT_SER_STUCKAT_ZERO
printf "" >> $NCSIM_INPUT_PAR_STUCKAT_SDF
printf "" >> $NCSIM_INPUT_SER_STUCKAT_SDF

printf "" >> $NCSIM_INPUT_PAR_ATSPEED_ZERO
printf "" >> $NCSIM_INPUT_SER_ATSPEED_ZERO
...
if ($GUI_P0 == 1) then
 perl -p -i -e "s/_parallel -/_parallel -gui -/g" $RUNSIM_ZERO
endif

if ($GUI_S0 == 1) then  
 perl -p -i -e "s/_serial -/_serial -gui -/g" $RUNSIM_ZERO
endif
...
if ($WAVES_P == 1) then 
 ...
 printf "#Specify here the database creation\n" >> ${IPF_DESIGN_FLOW_SCRIPTS}/nc/support_files/FULLSCAN_data_scan_ex1_ts1_1_verilog_parallel_sdf.inp
 printf "database -open waves_parallel_shift_sdf -into waves_parallel_shift_sdf.shm -default -event\n" >> $NCSIM_INPUT_PAR_SHIFT_SDF
 printf "probe -create -shm -all -depth all -database waves_parallel_shift_sdf\n" >> $NCSIM_INPUT_PAR_SHIFT_SDF
 
 printf "#Specify here the database creation\n" >> ${IPF_DESIGN_FLOW_SCRIPTS}/nc/support_files/FULLSCAN_data_logic_ex2_ts1_2_verilog_parallel_sdf.inp
 printf "database -open waves_parallel_stuckat_sdf -into waves_parallel_stuckat_sdf.shm -default -event\n" >> $NCSIM_INPUT_PAR_STUCKAT_SDF
 printf "probe -create -shm -all -depth all -database waves_parallel_stuckat_sdf\n" >> $NCSIM_INPUT_PAR_STUCKAT_SDF
 
 printf "#Specify here the database creation\n" >> ${IPF_DESIGN_FLOW_SCRIPTS}/nc/support_files/DELAY_data_logic_ex2_ts1_2_verilog_parallel_sdf.inp
 printf "database -open waves_parallel_atspeed_sdf -into waves_parallel_atspeed_sdf.shm -default -event\n" >> $NCSIM_INPUT_PAR_ATSPEED_SDF
...
if ($WAVES_S == 1) then  
 ...
 printf "database -open waves_serial_shift_sdf -into waves_serial_shift_sdf.shm -default -event\n" >> $NCSIM_INPUT_SER_SHIFT_SDF
 ...
 printf "database -open waves_serial_stuckat_sdf -into waves_serial_stuckat_sdf.shm -default -event\n" >> $NCSIM_INPUT_SER_STUCKAT_SDF
 printf "probe -create -shm -all -depth all -database waves_serial_stuckat_sdf\n" >> $NCSIM_INPUT_SER_STUCKAT_SDF
 
 printf "#Specify here the database creation\n" >> ${IPF_DESIGN_FLOW_SCRIPTS}/nc/support_files/DELAY_data_logic_ex2_ts1_verilog_serial_sdf.inp
 printf "database -open waves_serial_atspeed_sdf -into waves_serial_atspeed_sdf.shm -default -event\n" >> $NCSIM_INPUT_SER_ATSPEED_SDF
...
if ($WAVES_P0 == 1) then 
 ...
 perl -p -i -e 's#_parallel -gateloopwarn \\#_parallel -gateloopwarn \\\n\t\t -input \${IPF_DESIGN_FLOW_SCRIPTS}/nc/support_files/\${testname}_parallel.inp \\#g' $RUNSIM_ZERO

 printf "#Specify here the database creation\n" >> ${IPF_DESIGN_FLOW_SCRIPTS}/nc/support_files/FULLSCAN_data_scan_ex1_ts1_1_verilog_parallel.inp
 printf "database -open waves_parallel_shift -into waves_parallel_shift.shm -default -event\n" >> $NCSIM_INPUT_PAR_SHIFT_ZERO
 printf "probe -create -shm -all -depth all -database waves_parallel_shift\n" >> $NCSIM_INPUT_PAR_SHIFT_ZERO
 
 printf "#Specify here the database creation\n" >> ${IPF_DESIGN_FLOW_SCRIPTS}/nc/support_files/FULLSCAN_data_logic_ex2_ts1_2_verilog_parallel.inp
 printf "database -open waves_parallel_stuckat -into waves_parallel_stuckat.shm -default -event\n" >> $NCSIM_INPUT_PAR_STUCKAT_ZERO
 printf "probe -create -shm -all -depth all -database waves_parallel_stuckat\n" >> $NCSIM_INPUT_PAR_STUCKAT_ZERO
 
 printf "#Specify here the database creation\n" >> ${IPF_DESIGN_FLOW_SCRIPTS}/nc/support_files/DELAY_data_logic_ex2_ts1_2_verilog_parallel.inp
 printf "database -open waves_parallel_atspeed -into waves_parallel_atspeed.shm -default -event\n" >> $NCSIM_INPUT_PAR_ATSPEED_ZERO
 printf "probe -create -shm -all -depth all -database waves_parallel_atspeed\n" >> $NCSIM_INPUT_PAR_ATSPEED_ZERO
 
endif

if ($WAVES_S0 == 1) then  
 perl -p -i -e 's#_serial -gateloopwarn \\#_serial -gateloopwarn \\\n\t\t -input \${IPF_DESIGN_FLOW_SCRIPTS}/nc/support_files/\${testname}_serial.inp \\#g' $RUNSIM_ZERO
 
 printf "#Specify here the database creation\n" >> ${IPF_DESIGN_FLOW_SCRIPTS}/nc/support_files/FULLSCAN_data_scan_ex1_ts1_verilog_serial.inp
 printf "database -open waves_serial_shift -into waves_serial_shift.shm -default -event\n" >> $NCSIM_INPUT_SER_SHIFT_ZERO
 ...
 printf "database -open waves_serial_stuckat -into waves_serial_stuckat.shm -default -event\n" >> $NCSIM_INPUT_SER_STUCKAT_ZERO
 printf "probe -create -shm -all -depth all -database waves_serial_stuckat\n" >> $NCSIM_INPUT_SER_STUCKAT_ZERO
 
 printf "#Specify here the database creation\n" >> ${IPF_DESIGN_FLOW_SCRIPTS}/nc/support_files/DELAY_data_logic_ex2_ts1_verilog_serial.inp
 printf "database -open waves_serial_atspeed -into waves_serial_atspeed.shm -default -event\n" >> $NCSIM_INPUT_SER_ATSPEED_ZERO
...
if ($FORCES == 1) then  
  ...
  if($SDF_SIM == 1) then
    ...
    perl -p -i -e 's#FULLSCAN#DELAY#g' $NCSIM_INPUT_PAR_ATSPEED_SDF
  endif
  
  if($ZERO_SIM == 1) then 
    cat $NCSIM_INPUT_PAR_SHIFT_ZERO $FORCEFILE > $NCSIM_INPUT_PAR_SHIFT_ZERO.new
    mv  $NCSIM_INPUT_PAR_SHIFT_ZERO.new $NCSIM_INPUT_PAR_SHIFT_ZERO  
    cat $NCSIM_INPUT_PAR_STUCKAT_ZERO $FORCEFILE > $NCSIM_INPUT_PAR_STUCKAT_ZERO.new
    mv  $NCSIM_INPUT_PAR_STUCKAT_ZERO.new $NCSIM_INPUT_PAR_STUCKAT_ZERO  
    cat $NCSIM_INPUT_PAR_ATSPEED_ZERO $FORCEFILE > $NCSIM_INPUT_PAR_ATSPEED_ZERO.new
    mv  $NCSIM_INPUT_PAR_ATSPEED_ZERO.new $NCSIM_INPUT_PAR_ATSPEED_ZERO
    perl -p -i -e 's#FULLSCAN#DELAY#g' $NCSIM_INPUT_PAR_ATSPEED_ZERO
  endif
...
if ($FORCES == 1) then
  ...
  if($SDF_SIM == 1) then
    ...
    perl -p -i -e 's#FULLSCAN#DELAY#g' $NCSIM_INPUT_SER_ATSPEED_SDF
  endif
  
  if($ZERO_SIM == 1) then
    cat $NCSIM_INPUT_SER_SHIFT_ZERO $FORCEFILE > $NCSIM_INPUT_SER_SHIFT_ZERO.new
    mv  $NCSIM_INPUT_SER_SHIFT_ZERO.new $NCSIM_INPUT_SER_SHIFT_ZERO
    cat $NCSIM_INPUT_SER_STUCKAT_ZERO $FORCEFILE > $NCSIM_INPUT_SER_STUCKAT_ZERO.new
    mv  $NCSIM_INPUT_SER_STUCKAT_ZERO.new $NCSIM_INPUT_SER_STUCKAT_ZERO 
    cat $NCSIM_INPUT_SER_ATSPEED_ZERO $FORCEFILE > $NCSIM_INPUT_SER_ATSPEED_ZERO.new
    mv  $NCSIM_INPUT_SER_ATSPEED_ZERO.new $NCSIM_INPUT_SER_ATSPEED_ZERO
    perl -p -i -e 's#FULLSCAN#DELAY#g' $NCSIM_INPUT_SER_ATSPEED_ZERO
  endif
...
if ( ($FORCES == 1) || ($WAVES_S0 == 1) )then
 printf "run" >>  $NCSIM_INPUT_SER_SHIFT_ZERO
 printf "run" >>  $NCSIM_INPUT_SER_STUCKAT_ZERO
 printf "run" >>  $NCSIM_INPUT_SER_ATSPEED_ZERO
...
if ( ($FORCES == 1) || ($WAVES_P0 == 1) )then
 printf "run" >>  $NCSIM_INPUT_PAR_SHIFT_ZERO
 printf "run" >>  $NCSIM_INPUT_PAR_STUCKAT_ZERO
 printf "run" >>  $NCSIM_INPUT_PAR_ATSPEED_ZERO
...
if ( (($FORCES == 1) || ($WAVES_P0 == 1) || ($WAVES_S0 == 1) || ($GUI_S0 == 1) || ($GUI_P0 == 1)) && ($ZERO_SIM == 1) )then
    ...
    $LSF wish $RUNSIM_ZERO
else
  if ($ZERO_SIM == 1) then
    echo "running zero delay simulation without arguments"
    $LSF wish $IPF_DESIGN_FLOW_SCRIPTS/nc/run_zero_sim.tcl 
  endif   
endif
...
if ( (($FORCES == 1) || ($WAVES_P == 1) || ($WAVES_S == 1) || ($GUI_S == 1) || ($GUI_P == 1)) && ($SDF_SIM == 1) )then
  ...
  if ($SDF_SIM == 1) then
    ...
    $LSF wish $IPF_DESIGN_FLOW_SCRIPTS/nc/run_sdf_sim.tcl 
  endif
endif


rm -rf $IPF_DESIGN_FLOW_SCRIPTS/nc/local_SDF.tcl
rm -rf $IPF_DESIGN_FLOW_SCRIPTS/nc/local_ZERO.tcl

rm -rf $NCSIM_INPUT_PAR_SHIFT_ZERO
rm -rf $NCSIM_INPUT_SER_SHIFT_ZERO
rm -rf $NCSIM_INPUT_PAR_SHIFT_SDF
rm -rf $NCSIM_INPUT_SER_SHIFT_SDF

rm -rf $NCSIM_INPUT_PAR_STUCKAT_ZERO
rm -rf $NCSIM_INPUT_SER_STUCKAT_ZERO
rm -rf $NCSIM_INPUT_PAR_STUCKAT_SDF
rm -rf $NCSIM_INPUT_SER_STUCKAT_SDF

rm -rf $NCSIM_INPUT_PAR_ATSPEED_ZERO
rm -rf $NCSIM_INPUT_SER_ATSPEED_ZERO
rm -rf $NCSIM_INPUT_PAR_ATSPEED_SDF
rm -rf $NCSIM_INPUT_SER_ATSPEED_SDF

if ($OTHER_ARGUMENTS == 1) then
  rm -rf $IPF_DESIGN_FLOW_SCRIPTS/nc/support_files/other_arguments
endif
