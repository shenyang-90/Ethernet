...
#                                                                              #
# This is a scan_capture ONLY mode example constraints file                    #
...
set_case_analysis 0 [get_pins scanen]
...
create_clock -name CLK2 [get_pins -nocase <path_to_CLK2_pin>]  -period $CLK2_PERIOD -waveform "0 $CLK2_HALF" 
...
create_generated_clock -name CLK1_GENERATED_CLK -divide_by 1 -add -master_clock [get_clocks CLK1] \
                       ...
                       [get_pins -nocase <path_to_CLK1_GENERATED_CLK_PIN>]


create_generated_clock -name CLK2_GENERATED_CLK -divide_by 2 -add -master_clock [get_clocks CLK2] \
                       -source [get_pins -nocase <path_to_CLK2_pin>] \
                       [get_pins -nocase <path_to_CLK2_GENERATED_CLK_PIN>]
...
set clk1_input [get_ports <all_clk1_inputs>]
set clk2_input [get_ports <all_clk2_inputs>]


### Group all outputs ###
### Remove clock out ports from outputs ###
set clk1_output [get_ports <all_clk1_outputs>] 
set clk2_output [get_ports <all_clk2_outputs>] 
...
###############################################################################
set_false_path -through [get_pins -nocase {*/flop_reg/D} ]
