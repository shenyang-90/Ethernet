...
#------------------------------------------------------------------------------
#
#    Primary Unit Name :      clp_post_ccopt.do
#
#          Description :      CLP post ccopt check
#
...
set_log_file $_CLP_RPT_PATH/clp_postccopt.log -replace
...
set lowpower option -witness_limit 0 
...
read_design  -noelab ${_PNR_DATA_PATH}/$DESIGN.postccoptincr.v
...
tclmode
report_rule_check -LP -verbose > $_CLP_RPT_PATH/clp_postccopt.rpt
exit 
