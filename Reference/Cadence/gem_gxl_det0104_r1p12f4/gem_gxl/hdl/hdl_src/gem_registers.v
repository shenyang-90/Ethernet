...
module gem_registers(
  ...
  //jumbo packet max length
  output  reg [13:0]  jumbo_max_length;     // progammable max length
    ...
    begin
      ...
      begin
        case (i_paddr)
          ...
          `gem_stretch_ratio        : stretch_ratio       <= pwdata[15:0];
  ...
  begin : p_read_register
    ...
    begin
      case (i_paddr)
        ...
        `gem_stretch_ratio        : prdata_i_nq = {16'h0000,stretch_ratio};
