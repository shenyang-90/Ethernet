...
`ifndef xgm
  ...
  `ifdef gem_asf_enable
    `define gem_asf_dap_prot
    `define gem_asf_csr_prot
    `define gem_asf_trans_to_prot
    `define gem_asf_integrity_prot
  `endif
 ...
 `ifdef gem_asf_dap_prot
    `ifndef edma_any_asf
      `define edma_any_asf
    `endif
    `define edma_asf_dap_prot
    `define emac_parity_width ((`gem_emac_bus_width >= 128)? 32'd16 : ((`gem_emac_bus_width >= 64)? 32'd8 : 32'd4))
    `define edma_parity_width ((`gem_dma_bus_width >= 128)? 32'd16 : ((`gem_dma_bus_width >= 64)? 32'd8 : 32'd4))
    `define edma_rx_pbuf_prty ((`gem_rx_pbuf_data >= 128)? 32'd16 : ((`gem_rx_pbuf_data >= 64)? 32'd8 : 32'd4))
    `define edma_tx_pbuf_prty ((`gem_tx_pbuf_data >= 128)? 32'd16 : ((`gem_tx_pbuf_data >= 64)? 32'd8 : 32'd4))
  `else
 ...
 `ifdef gem_asf_enable
  `ifdef gem_asf_ecc_sram
    `ifndef edma_any_asf
      `define edma_any_asf
    `endif
    `define edma_asf_ecc_sram
    `define edma_rx_pbuf_temp ((`gem_rx_pbuf_data >= 128)? 32'd16 : ((`gem_rx_pbuf_data >= 64)? 32'd8 : 32'd7))
    `define edma_tx_pbuf_temp ((`gem_tx_pbuf_data >= 128)? 32'd16 : ((`gem_tx_pbuf_data >= 64)? 32'd8 : 32'd7))
    `define edma_rx_pbuf_reduncy ( `edma_rx_pbuf_temp + ((`gem_rx_pbuf_addr+7)/8))
    `define edma_tx_pbuf_reduncy ( `edma_tx_pbuf_temp + ((`gem_tx_pbuf_addr+7)/8))
    `define edma_emac_rx_pbuf_reduncy ( `edma_rx_pbuf_temp + ((`gem_emac_rx_pbuf_addr+7)/8))
    `define edma_emac_tx_pbuf_reduncy ( `edma_tx_pbuf_temp + ((`gem_emac_tx_pbuf_addr+7)/8))
  `else
    `ifdef gem_asf_dap_prot
      `define edma_rx_pbuf_temp ((`gem_rx_pbuf_data >= 128)? 32'd16 : ((`gem_rx_pbuf_data >= 64)? 32'd8 : 32'd4))
      `define edma_tx_pbuf_temp ((`gem_tx_pbuf_data >= 128)? 32'd16 : ((`gem_tx_pbuf_data >= 64)? 32'd8 : 32'd4))
      `define edma_rx_pbuf_reduncy ( `edma_rx_pbuf_temp + ((`gem_rx_pbuf_addr+7)/8))
      `define edma_tx_pbuf_reduncy ( `edma_tx_pbuf_temp + ((`gem_tx_pbuf_addr+7)/8))
      `define edma_emac_rx_pbuf_reduncy ( `edma_rx_pbuf_temp + ((`gem_emac_rx_pbuf_addr+7)/8))
      `define edma_emac_tx_pbuf_reduncy ( `edma_tx_pbuf_temp + ((`gem_emac_tx_pbuf_addr+7)/8))
 ...
 `endif
  ...
  `ifdef gem_asf_integrity_prot
    `ifndef edma_any_asf
      `define edma_any_asf
    `endif
    `define edma_asf_integrity_prot
  `endif
