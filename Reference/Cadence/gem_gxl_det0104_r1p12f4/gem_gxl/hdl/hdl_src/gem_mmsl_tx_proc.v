...
module gem_mmsl_tx_proc (
  ...
  assign ipg_timer       = (c_state == RESUME_WAIT || c_state == E_TX_COMPLETE || c_state == P_TX_COMPLETE || c_state == IDLE)? ipg_timer1 : 5'd0;
  assign ipg_timer_done  = (ipg_timer == 5'd0 && c_state != INIT_TX);
