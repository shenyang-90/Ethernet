...
- [x] §10.2 语义三级定义清晰，MACsec/AVTP 已修正
- [x] §8.1 P0 升级项有需求追溯或已降级
- [x] §6.1 含 GETH_AI.028/030 独立条目，总数 15
- [x] §2.1 DMA 通道标注泛化
- [x] §6.2.6 BC 模式消除固定成对误解
- [x] §1.4.4 门数估算有 §4.3 引用
- [x] §1.4.1 含 SUPPORT_SRP/SUPPORT_PFC
- [x] 802.1Qbu RTL Complexity 有评估结论
